/**
 * =========================================================================================
 * Project     : Arduino Uno Long-Range UHF RFID Vehicle Toll Gate & Loop Detector
 * Platform    : Arduino Uno / ATmega328P
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Automated vehicle barrier controller reading EPC Gen2 UHF RFID tags from 6 meters, processing inductive ground loop vehicle presence, and driving servo boom gate.
 * =========================================================================================
 */
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" Arduino Uno Long-Range UHF RFID Vehicle Toll Gate & Loop Detector"));
