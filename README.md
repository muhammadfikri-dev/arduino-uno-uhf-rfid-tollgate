# ⚡ Arduino Uno Long-Range UHF RFID Vehicle Toll Gate & Loop Detector
...
Automated vehicle barrier controller reading EPC Gen2 UHF RFID tags from 6 meters, processing inductive ground loop vehicle presence, and driving servo boom gate.
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `EEPROM`
4. Buka berkas [`arduino-uno-uhf-rfid-tollgate.ino`](./arduino-uno-uhf-rfid-tollgate.ino).
